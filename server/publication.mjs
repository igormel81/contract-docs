...
const assets=new Map([
  ['/docs/downloads/contract-docs-0.3.6.tar.gz',['downloads/contract-docs-0.3.6.tar.gz','application/gzip','contract-docs-0.3.6.tar.gz']],
  ['/docs/downloads/contract-docs-0.3.6.tar.gz.sha256',['downloads/contract-docs-0.3.6.tar.gz.sha256','text/plain; charset=utf-8','contract-docs-0.3.6.tar.gz.sha256']],
  ['/docs/downloads/contract-docs-0.3.5.tar.gz',['downloads/contract-docs-0.3.5.tar.gz','application/gzip','contract-docs-0.3.5.tar.gz']],
  ['/docs/downloads/contract-docs-0.3.5.tar.gz.sha256',['downloads/contract-docs-0.3.5.tar.gz.sha256','text/plain; charset=utf-8','contract-docs-0.3.5.tar.gz.sha256']],
